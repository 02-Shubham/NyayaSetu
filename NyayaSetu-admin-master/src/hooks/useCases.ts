    ...
    const fetchCases = useCallback(async () => {
        ...
        try {
            ...
            const casePromises = logs.map(async (log: any) => {
                ...
                try {
                    // Try to fetch title from IPFS for the list view
                    // We strip 'ipfs://' prefix if present for the gateway URL
