...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`${inter.className} ${inter.variable} ${playfair.variable} bg-bg-page text-text-main antialiased selection:bg-brand-primary/10 min-h-screen relative`}>
